<template>
    <div v-if="show && product" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
        ...
        <div class="flex flex-col h-full">
          ...
          <div class="bg-gradient-to-r from-sky-600 to-cyan-600 p-6 text-white">
            ...
            <div class="flex space-x-4 text-sm">
              ...
              <p><span class="font-semibold">Inventory:</span> {{ product.inventory }}</p>
          ...
          <div class="flex-grow overflow-auto p-6">
            ...
            <h3 class="text-xl font-semibold mt-6 mb-4">Associated Feeds</h3>
  
            <div class="overflow-y-auto max-h-[calc(100vh-20rem)]">
              <table class="w-full text-sm">
                <thead>
                  <tr class="bg-gray-50 text-gray-600 uppercase text-xs">
                    <th class="sticky top-0 p-3 text-left bg-gray-50">Feed Name</th>
                    <th class="sticky top-0 p-3 text-left bg-gray-50">Actions</th>
                  </tr>
                </thead>
                <tbody>
                  <tr
                  ...
                  >
                    ...
                    <td class="p-3">
                      <OutlinedButton
                        @click="handleDetachFeed(feed.id)"
                        color="red"
                        text="Detach"
                        class="ml-2"
                      />
  ...
  const handleDetachFeed = (feedId) => {
    emit('detach-feed', props.product.id, feedId);
  };
  </script>