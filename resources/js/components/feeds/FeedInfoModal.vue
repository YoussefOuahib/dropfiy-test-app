  ...
  >
    <div v-if="feed" class="flex flex-col h-full">
      ...
      <div class="flex-grow overflow-hidden">
        <h3 class="text-xl font-semibold p-4 bg-gray-100 border-b border-gray-200">
          Products
        </h3>
          ...
          <table class="w-full text-sm">
            <thead>
              <tr class="bg-gray-50 text-gray-600 uppercase text-xs">
                <th class="sticky top-0 p-3 text-left bg-gray-50">Name</th>
                <th class="sticky top-0 p-3 text-left bg-gray-50">SKU</th>
                <th class="sticky top-0 p-3 text-left bg-gray-50">Price</th>
            ...
            <tbody>
              ...
              >
                ...
                <td class="p-3">
                  <OutlinedButton
                    @click="$emit('detach-product', feed.slug, product.id)"
                    color="red"
                    text="Detach"
                  />
                </td>
